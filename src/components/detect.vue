       ...
       <div>
        <div class="header">
            <form action="file_upload" method="post" onsubmit="return check()">
                <el-button type="text" @click="detect" style="margin-left:2%;color: #706875;font-weight: bold; font-size: 15px;  padding-left: 2%; padding-right: 2%; background-color: rgb(238, 241, 246);" ><p>输电线异物检测</p></el-button>
        ...
        methods: {
            ...
            // }else{
                ...
                var param = new FormData();
                        ...
                        axios.post("http://127.0.0.1:8801/api/upload", param).then(responce => {
                            if (responce==='success'){
                                this.$message({
                                                message: "异物检测完成！",
                                                duration: 1000
