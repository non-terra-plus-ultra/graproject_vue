  ...
  <div style="margin-left: 2%;margin-top: 2%;">
    ...
    highlight-current-row>
           <el-table-column width="200px" prop="result_time" fixed label="预测时间" :formatter='formatter' sortable>
            ...
            <el-button type="text" @click="getDetectAll(scope.$index,scope.row)" size="mini">本轮预测结果展示</el-button>
             </template>
  ...
  import axios, { all } from "axios";
   ...
   export default {
        ...
        methods:{
          ...
          getDetectAll(index,row){
            this.dialogVisible2=true
            var that = this;
            
            axios({
              method: "get",
              url: "http://127.0.0.1:8801/getDetectAll?"   ,
              params: {
                result_path:row.result_path,
              },
